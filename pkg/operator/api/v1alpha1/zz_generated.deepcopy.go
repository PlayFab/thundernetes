...
func (in *GameServerStatus) DeepCopyInto(out *GameServerStatus) {
	*out = *in
	...
	if in.ReachedInitializingOn != nil {
		in, out := &in.ReachedInitializingOn, &out.ReachedInitializingOn
		*out = (*in).DeepCopy()
	}
	if in.ReachedStandingByOn != nil {
		in, out := &in.ReachedStandingByOn, &out.ReachedStandingByOn
		*out = (*in).DeepCopy()
	}
	if in.ReachedActiveOn != nil {
		in, out := &in.ReachedActiveOn, &out.ReachedActiveOn
		*out = (*in).DeepCopy()
	}
}
